...
HueJS = function(params){
	...
	var config = {
		...
		username : params.username || "newdeveloperryan",
	...
	*/
	...
	//setup some globals
	//validation on user input to make sure it is in fact an ip address given
	var myUS,myIP,hjs;
	...
	$(function(){
		$("#configHue").click(function(e){
			e.preventDefault();
			myUS = $("input[name=hue-username]").val();
			myIP = $("input[name=hue-ip]").val();
			if(ValidateIPaddress(myIP)){
    			hjs = HueJS({
        			ipAddress: myIP,
    			...
    			hjs.authenticate( function(){
					
    				alert("Successfully Connected to HUE Bridge");
...
/*     				$("#GUI").show(); */
			    ...
			    alert('The IP address you have provided is invalid');
			}
		});
		...
		$('#btn3').click(function(e){
			e.preventDefault();
			var res = hjs.setHueSat(1,45869,255);
			console.log(res);
		...
		$('#btn4').click(function(e){
			e.preventDefault();
			var res = hjs.setHueSat(1,65124,255);
			console.log(res);
			res = hjs.setHueSat(3,0,255);
			console.log(res);
			res = hjs.setHueSat(4,0,255);
		...
		$('#btn5').click(function(e){
			e.preventDefault();
			var res = hjs.setHueSat(1,12750,255);
			console.log(res);
			res = hjs.setHueSat(3,0,255);
			console.log(res);
			res = hjs.setHueSat(4,0,255);
		...
		$('#btn6').click(function(e){
			e.preventDefault();
			var res = hjs.setHueSat(1,20384,255);
			console.log(res);
			res = hjs.setHueSat(3,0,255);
			console.log(res);
			res = hjs.setHueSat(4,0,255);
...
$(function() {
    ...
    $('a.popper').mousemove(function(e) {
        ...
        $(target).css('top', topD).css('left', leftD + 20);
    });
